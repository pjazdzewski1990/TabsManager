...
function listenForClicks() {
  document.addEventListener("click", (e) => {
    ...
    function beastNameToURL(beastName) {
      switch (beastName) {
        case "Frog":
          return browser.extension.getURL("resources/frog.jpg");
        case "Snake":
          return browser.extension.getURL("resources/snake.jpg");
        case "Turtle":
          return browser.extension.getURL("resources/turtle.jpg");
      }
    }
